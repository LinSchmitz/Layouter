  ...
  return (
    <>
      <div style={{ maxWidth: '800px', margin: '2rem auto', padding: '1rem' }}>
        ...
        <p style={{ lineHeight: 1.6, marginBottom: '1rem' }}>
          Instead of writing layout CSS by hand, Layouter lets you visually
          adjust settings like direction, alignment, and gaps, and instantly see
          the result. It also generates real-time CSS code that you can copy and
